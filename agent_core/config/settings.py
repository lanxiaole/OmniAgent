...
# 场景配置文件路径（与 settings.py 同目录）—— 内置场景，随程序分发，完全只读
...
# =============================================================================
# 场景系统（数据层）
#   内置场景：只读，位于 agent_core/config/scenarios.json（随程序分发，字段不可改）
#   自定义场景：可读写，位于 {USER_DATA_DIR}/scenarios/custom.json
#   显示偏好：可读写，位于 {USER_DATA_DIR}/scenarios/display.json
# =============================================================================
