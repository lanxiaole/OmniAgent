...
下面通过实际运行截图展示 OmniAgent 的核心功能。

### 对话与智能助手

对话界面支持流式输出与工具调用，并可视化展示 Agent 的思考过程。

| 截图 | 说明 |
| :--- | :--- |
| ![对话页面](capture/对话页面展示.png) | 对话主界面 |
| ![对话功能](capture/对话功能展示.png) | 对话功能与智能助手 |
| ![上下文计算](capture/上下文计算展示.png) | 上下文概况与 Token 占用 |
| ![检索知识库](capture/检索知识库展示.png) | 对话中检索知识库 |
| ![检索记忆](capture/检索记忆展示.png) | 对话中检索用户记忆 |

### 长期记忆

Agent 会在对话中自动记录你的偏好，并支持偏好变更时自动更新。

| 截图 | 说明 |
| :--- | :--- |
| ![自动管理记忆](capture/自动管理记忆.png) | 自动收集用户信息 |
| ![自动管理记忆-更改](capture/自动管理记忆--更改记忆.png) | 自动更新变更的记忆 |
| ![记忆页面](capture/记忆页面展示.png) | 记忆管理页面 |

### 知识库与文件

| 截图 | 说明 |
| :--- | :--- |
| ![知识库页面](capture/知识库页面展示.png) | 知识库管理页面 |
| ![文件页面](capture/文件页面展示.png) | 文件浏览页面 |

### 场景

通过场景管理定制不同角色的 Agent 对话风格。

| 截图 | 说明 |
| :--- | :--- |
| ![场景管理](capture/设置--场景管理.png) | 场景管理 |
| ![新建场景](capture/设置--场景管理--新建场景.png) | 新建自定义场景 |
| ![选择场景](capture/选择自定义场景.png) | 选择自定义场景 |
| ![使用自定义场景](capture/使用自定义场景.png) | 使用自定义场景对话 |
| ![写作助手](capture/对话场景--写作助手.png) | 写作助手场景对话 |

### 设置

| 截图 | 说明 |
| :--- | :--- |
| ![模型管理](capture/设置--模型管理界面.png) | 模型管理界面 |
| ![API配置](capture/设置--API配置.png) | API 配置 |
| ![工作区](capture/设置--工作区.png) | 工作区管理 |
| ![服务状态](capture/设置--服务状态页面.png) | 服务状态页面 |
| ![关于](capture/设置--关于.png) | 关于页面 |
...
**Q: 知识库上传后检索不到？**
上传后需重建向量库（知识库页面点击「重建」），且当前支持 `.txt`、`.md` 与 `.pdf` 格式。
